...
export default function SignUp() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!json.success) {
            ...
            window.confirm("Account Created, Go to login page")
        }
    }
    ...
    return (
        <section className="vh-100" style={{ "backgroundcolor": "#eee", "background":"bg.jpg.avif" }}>
                            ...
                            <div className="card-body p-md-5">
                                <div className="row justify-content-center">
                                        ...
                                        <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                                            ...
                                            <div className="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div className="form-outline flex-fill mb-0">
                                                    ...
                                                    <label className="form-label" htmlFor="form3Example5c" >Your Address</label>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                                ...
                                                <Link to="/login" className='m-3 btn btn-danger btn-lg'>Already a user</Link>
                                            </div>
                                    ...
                                    <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                        ...
                                        {/* <img src="biryani.webp" className="img-fluid" alt="Sample image" /> */}
                                        <img src="blogo.jpeg" className="img-fluid" alt="Sample image" style={{filter:"brightness(60%)"}} />
